...
def seed():  # noqa: C901
    ...
    try:
        ...
        audit_actions = [
            ...
            ("delete", "vehicle", "Soft-deleted vehicle {reg}"),
            ("retire", "vehicle", "Retired vehicle {reg}"),
            ...
            ("update", "category", "Updated maintenance category"),
            ("delete", "category", "Soft-deleted maintenance category"),
            ("create", "user", "Created user {name}"),
            ("update", "user", "Updated user {name}"),
            ("create", "maintenance_record", "Created maintenance record"),
            ("update", "maintenance_record", "Updated maintenance record"),
            ("delete", "maintenance_record", "Deleted maintenance record"),
            ("create", "mileage_record", "Created mileage record"),
            ("update", "mileage_record", "Updated mileage record"),
            ("delete", "mileage_record", "Deleted mileage record"),
            ("create", "retirement_request", "Submitted retirement request for {reg}"),
            ("approve", "retirement_request", "Approved retirement request"),
            ("reject", "retirement_request", "Rejected retirement request"),
            ("create", "deletion_request", "Submitted deletion request"),
